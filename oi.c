...
#define IMAGENAME "oiteste10.bmp" /* nome do arquivo de imagem */
...
int main(void)
{
    ...
    circlefill(buff, 350, 120, 100, CORAZUL);
    textprintf_ex(buff, font, 10, 10, CORVERDE, CORPRETO, "MOVENDO ALGUEM!");
